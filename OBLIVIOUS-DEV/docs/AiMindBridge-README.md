...
> **OBSOLETE — archived reference only.**  Live stack is `oblivious-hub/` (Electron) + ZeroMQ.  
> Canonical copy of this tree: `OBLIVIOUS-DEV/project/legacy-frozen/AiMindBridge/`.

Named-pipe bridge (historical documentation follows).
